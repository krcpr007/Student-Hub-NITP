          ...
          <div className='grid grid-rows-6 place-items-center'>
            ...
            <div className=''>
              ...
              <svg aria-label="Direct" className="_ab6-" color="#fff" fill="#fff" height="96" role="img" viewBox="0 0 96 96" width="96">
                ...
                <line fill="none" stroke="currentColor" strokeLinejoin="round" stroke-width="2" x1="69.286" x2="41.447" y1="33.21" y2="48.804" className={`stroke-width-2 ${darkMode ? " stroke-white" : "stroke-black"}`}></line>
