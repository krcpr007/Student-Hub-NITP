...
function PostCard({ post, id, fetchPosts }) {
    ...
    return (
        <>
            <div className={`mt-3 shadow rounded mb-3 mx-2  dark:bg-slate-900  dark:bg-gradient-to-r from-gray-700 via-gray-900 to-black dark:text-white dark:shadow-yellow-500`}>
