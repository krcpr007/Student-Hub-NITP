    ...
    return (
        <div className='shadow w-2/3 mt-2 rounded ml-10'>
            <div className='ml-12 mt-2 '>
               <a href="/"><img src="https://avatars.githubusercontent.com/u/80947662?v=4" alt="" className='w-2/3 content-center rounded-full' /></a>
            </div>
            <h1 className='mt-1 font-medium text-xl text-center px-5'>Rajan Kumar</h1>
